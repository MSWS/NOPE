...
public class Checks {
	...
	public void registerChecks() {
		Check[] checks = { new Flight1(), new Flight2(), new Flight3(), new NoGround1(), new Speed1(), new Speed2(), new Speed3(),
				...
				new AutoClicker1(), new HighCPS1(), new HighCPS2(), new HighCPS3() };
